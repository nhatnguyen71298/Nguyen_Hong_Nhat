...
<nav class="navbar navbar-light bg-light pt-3">
    <a class="navbar-brand" href="#">
        <img style="margin-left: 50px"
             src="https://vinadomain.vn/wp-content/uploads/2020/06/logo-maker-e1591540943421.png" width="50" height="50"
...
<div class="container-fluid pt-5"
     style="background-image: url(https://1.bp.blogspot.com/-sP3dIHuoTYw/TcQWWUfQJ2I/AAAAAAAAAnI/akgXrJLmTHo/s1600/Hoi+An+096.jpg)">
    <div class="row">
        ...
        <div class="col-10">
            <form method="post" action="/customer?action=edit">
                <input class="form-control" type="hidden" value="${customerEdit.id}" name="id">
                ...
                <input class="form-control" type="text" value="${customerEdit.name}" name="name">
                <input class="form-control" type="date" value="${customerEdit.birthday}" name="birthday">
                <input class="form-control" type="text" value="${customerEdit.gender}" name="gender">
                <input class="form-control" type="text" value="${customerEdit.cmnd}" name="cmnd">
                <input class="form-control" type="text" value="${customerEdit.phoneNumber}" name="phone_number">
                <input class="form-control" type="text" value="${customerEdit.email}" name="email">
                <input class="form-control" type="text" value="${customerEdit.address}" name="address">
