...
<div class="container-fluid pt-5" style="background-image: url(https://1.bp.blogspot.com/-sP3dIHuoTYw/TcQWWUfQJ2I/AAAAAAAAAnI/akgXrJLmTHo/s1600/Hoi+An+096.jpg)">
    <div class="row">
        ...
        <div class="col-10">
            <form method="post" action="/customer?action=create_customer">
                ...
                <input class="form-control" type="date" placeholder="Input birthday" name="birthday">
                <input class="form-control" type="text" placeholder="Input gender" name="gender">
                <input class="form-control" type="text" placeholder="Input CMND" name="cmnd">
                <input class="form-control" type="text" placeholder="Input phone number" name="phone_number">
                <input class="form-control" type="text" placeholder="Input email" name="email">
                <input class="form-control" type="text" placeholder="Input address" name="address">
