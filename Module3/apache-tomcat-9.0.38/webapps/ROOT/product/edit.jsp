    ...
    <div class="row">
        ...
        <div class="col-10">
            <form method="post" action="/product?action=edit">
                <input class="form-control" type="hidden" value="${productEdit.stt}" name="stt">
                <p style="color: red;font-weight: bold">Name : </p>
                <input class="form-control" type="text" value="${productEdit.name}" name="name">
                <p style="color: red;font-weight: bold">Price : </p>
                <input class="form-control" type="text" value="${productEdit.price}" name="price">
                <p style="color: red;font-weight: bold">Quantity : </p>
                <input class="form-control" type="text" value="${productEdit.quantity}" name="quantity">
