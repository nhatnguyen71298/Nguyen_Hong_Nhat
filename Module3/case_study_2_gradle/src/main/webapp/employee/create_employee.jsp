    ...
    <div class="row">
        ...
        <div class="col-9">
            <form method="post" action="/employee?action=create">
                ...
                <input class="form-control" type="text" placeholder="Input salary" name="salary">
                <input class="form-control" type="text" placeholder="Input phone number" name="phoneNumber">
